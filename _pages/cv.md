...
### 1. Pattern Recognition and Machine Learning (PRML) *(CS5691, Jan 2024 – Apr 2024)*  
**IIT Madras**  
- Built classification models: Naive Bayes, KNN, Logistic Regression, Random Forest  
- Implemented Ridge Regression, Lasso Regression, K-Means Clustering, PCA, DBSCAN, GMM  

### 2. Computational Photography *(EE5176, Jan 2024 – Apr 2024)*  
**IIT Madras**  
- Explored image enhancement methods including demosaicing, denoising, alpha matting, motion deblurring, and compositing  
- Studied Bayer pattern processing, tone mapping, HDR imaging, coded aperture, and light field imaging  

### 3. Image Signal Processing (ISP) *(EE5157, Jan 2024 – Apr 2024)*  
**IIT Madras**  
- Performed image processing tasks in Python: geometric transformations, mosaicing, shape from focus, space-variant blurring, Otsu’s thresholding, occlusion detection  

### 4. Natural Language Processing *(CS6370, Jan 2024 – Apr 2024)*  
**IIT Madras**  
- Built a Python-based search engine with NLP modules: segmentation, tokenization, lemmatization, stopword removal, spell correction  
- Used NLTK, TF-IDF, WordNet for semantic query matching  

### 5. Data Analysis & Visualization in R/Python/SQL (DAV) *(MA5755, Jan 2024 – Apr 2024)*  
**IIT Madras**  
- Built a neural network from scratch for handwritten digit recognition  
- Achieved 87% training and 86% testing accuracy  

### 6. Probability Foundations for Electrical Engineers *(EE5110, Jul 2023 – Nov 2023)*  
**IIT Madras**  
- Studied expectation, variance, distributions, multivariate statistics, transformations, law of large numbers, probabilistic inequalities  
...
- **Student Placement Coordinator:** Coordinated placement season at IIT Bhubaneswar, handling 200+ students  
...
- **First Prize** in **Poster Presentation Competition**, Sandip University, Nashik  
